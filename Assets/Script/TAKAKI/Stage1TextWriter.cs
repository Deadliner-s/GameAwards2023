...
public class Stage1TextWriter : MonoBehaviour
{
    ...
    IEnumerator Cotest()
    {
        ...
        uitext.DrawNameText("≪ 司令官 ≫", "強力なビーム兵器「衛星軌道砲」により、敵巨大飛行物体を撃墜するのが本ミッションの目的である。");
        ...
        uitext.DrawNameText("≪ 司令官 ≫", "ヤツに接近しての照準補佐と、注意を引き続けてもらうことが君に課せられた任務だ。");
        ...
        uitext.DrawNameText("≪ 司令官 ≫", "苛烈な攻撃が予想されるが、音速戦闘とバリアフィールドを搭載するその機体であれば切り抜けることが可能なはずだ。");
        ...
        uitext.DrawNameText("≪ AI ≫", "まもなく敵巨大飛行物体の攻撃圏内に突入します。\n注意してください。");
        yield return new WaitForSeconds(6.0f);
